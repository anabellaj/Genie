...
class ModifyStudyMaterial extends StatefulWidget {
  const ModifyStudyMaterial(
      {super.key,
      required this.material,
      required this.topicId,
      required this.i,
      required this.group,
      required this.studyMaterialList});
...
class _ModifyStudyMaterial extends State<ModifyStudyMaterial> {
  ...
  void modifyFile() async {
    if (_titleController.text.isEmpty || _descLabelController.text.isEmpty) {
    ...
    StudyMaterial newMaterial =
        StudyMaterial(title: newTitle, description: newDesc);
    ...
    showDialog(
      ...
      if (value != null && value) {
        ...
        final result = await Controller.updateFile(
            newMaterial, widget.material.id, widget.topicId, widget.i);

        if (result == 'success') {
          //revisar como hay que pasar el id
          widget.material.title = newTitle;
          widget.material.description = newDesc;
  ...
  void deleteFile() async {
    ...
    showDialog(
      ...
      if (value != null && value) {
        ...
        final result = await Controller.deleteFile(
            widget.material.id, widget.topicId, widget.i);

        if (result == 'success') {
          widget.studyMaterialList.remove(widget.material);
          Navigator.of(context).pop();
          Navigator.of(context).pop();
        } else {
          ScaffoldMessenger.of(context).clearSnackBars();
