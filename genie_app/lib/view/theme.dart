...
final ThemeData genieThemeDataDemo = ThemeData(
    ...
    primaryTextTheme: GoogleFonts.breeSerifTextTheme(const TextTheme(
      ...
      headlineMedium: TextStyle(
          //titulos de pagina incio sesion
          color: Color(0xff084C6E),
          fontSize: 32.0),
      headlineSmall: TextStyle(
          //titulos de pagina sobre blanco
          color: Color(0xffFFFCFF),
          fontSize: 32.0),
      titleLarge: TextStyle(
          //titulos de foro en preview
          color: Color(0xff212227),
          fontSize: 20.0),
    )),
    ...
    textTheme: GoogleFonts.asapCondensedTextTheme(const TextTheme(
      ...
      displayLarge: TextStyle(
          ...
          color: Color(0xff212227),
          fontSize: 16),
      titleSmall: TextStyle(color: Color(0xffB4B6BF), fontSize: 14),
      titleMedium: TextStyle(color: Color(0xff212227), fontSize: 16),
      bodyLarge: TextStyle(
    ...
    snackBarTheme: const SnackBarThemeData(
      ...
      contentTextStyle: TextStyle(fontSize: 12, color: Color(0xffC5061D)),
...
ButtonStyle outlinedButtonStyle = ButtonStyle(
  ...
  foregroundColor:
      WidgetStatePropertyAll(genieThemeDataDemo.colorScheme.primary),
...
ButtonStyle deleteButtonStyle = ButtonStyle(
  ...
  foregroundColor:
      WidgetStatePropertyAll(genieThemeDataDemo.colorScheme.onError),
  textStyle: WidgetStatePropertyAll(genieThemeDataDemo.textTheme.bodySmall),
  padding: const WidgetStatePropertyAll(
      EdgeInsets.symmetric(vertical: 10, horizontal: 32)),
);
