...
class ControllerStudy {
  ...
  static Future updateStudied(
    ...
    try {
      ...
      if (studiedIds.isNotEmpty) {
        if (fullUser.flashCardsStudied
                .indexWhere((e) => e['topic'] == topicId) !=
            -1) {
          ...
          await Connection.updateUserFlashcard(
              user.id, fullUser.flashCardsStudied);
        } else {
  ...
  static Future<double> getPercent(Topic topicId, String userId) async {
    ...
    if (fullUser.flashCardsStudied
            .indexWhere((e) => e['topic'] == topicId.id) !=
        -1) {
      List studied = fullUser.flashCardsStudied[fullUser.flashCardsStudied
          .indexWhere((e) => e['topic'] == topicId.id)]['studied'];
